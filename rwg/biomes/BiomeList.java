...
public class BiomeList 
{
	...
	public static BiomeGenBase REALISTICyosemite;
	...
	public static void load()
	{
		...
		REALISTICyosemite = (new RealisticBiomeYosemite(205)).setColor(16777215).setBiomeName("Yosemite").setTemperatureRainfall(0.7F, 0.5F);
